<div id="page-wrapper" >
	...
	<div class="row" class="col-sm-5">
	  <div class="col-sm-4">
        <h2 style="margin-top:0px">Email Unsubscribers <small><br>Opted out emails <small>i.e. using email footer link</small></small></h2>
		</div>
	</div>
        <div class="row" style="margin-bottom: 10px">
             <div class="col-md-3 ">
				 <form action="<?php echo site_url('email_unsubscribers'); ?>" class="form-inline" method="get">
							...
							<div class="form-group">
									<?php       
										...
										{
											?>
											<a href="<?php echo site_url('email_unsubscribers'); ?>" class="btn btn-default" style="height:33px;">Reset</a>
											<?php
										}
										}
									?>
        ...
        <tr>
			...
			<!-- <td>  <?php
			            ...
			            ?></td> -->
			<td><?php $date = date_create($subscribers->subCreationDate); echo date_format($date, 'm-d-Y Hi'); ?></td>
			<td><?=$subscribers->subHeaders?></td>
