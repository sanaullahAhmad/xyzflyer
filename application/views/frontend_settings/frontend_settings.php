	<div id="page-wrapper" >
		<div class="page-content">
			...
			<h2 style="margin-top:0px"><?=$title?></h2>
                ...
                echo anchor(site_url('Frontend_settings/add_slider'),'Add Slider', 'class="btn btn-primary"'); 
			...
			<div class="">
				<table class="table table-bordered table-striped" id="mytable">
					...
					<td>
						<? echo anchor(site_url('Frontend_settings/enable_slider/'.$slide->id),($slide->status==1?'<span style="margin:2px;" class="btn btn-primary">Enable':'<span style="margin:2px;" class="btn btn-danger">Disable').'</span>','onclick="javasciprt: return confirm(\'Are You Sure ?\')",data-toggle="tooltip" title="Click to change status"'); ?>
					</td>
					<td>
