<div id="page-wrapper" >
	...
	<section>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Admin Activity List</h2>
            </div>
	    ...
	    <tbody>
			...
			echo '<a style="margin:2px;" class="btn btn-primary" href="'.site_url('admin_activity/read/'.$admin_activity->activity_id).'" data-toggle="tooltip" title="View"><i class="fa fa-bars"></i></a>';
            } if(xyzAccesscontrol('activity_managment','Delete')==TRUE){
			echo '<a style="margin:2px;" class="btn btn-danger" href="'.site_url('admin_activity/delete/'.$admin_activity->activity_id).'" onclick="javasciprt: return confirm(\'Are You Sure ?\')" data-toggle="tooltip" title="Delete"><i class="fa fa-times"></i></a>';
             }
			?>
		    </td>
	        </tr>
