...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Page Title Here -->
        <title>XYZ Flyers - Coming Soon</title>
		
        <!-- Page Description Here -->
		<meta name="description" content="XYZ Flyers will be launching soon">
        ...
        <!-- Initializer -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/normalize.css">        
        
        <!-- Web fonts and Web Icons -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/pageloader.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/fonts/opensans/stylesheet.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/fonts/asap/stylesheet.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/ionicons.min.css">
        
        <!-- Vendor CSS style -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/foundation.min.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/js/vendor/jquery.fullPage.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/js/vegas/vegas.min.css">
        
		<!-- Main CSS files -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/main.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/main_responsive.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/main_page/css/style-color1.css">
        
        <script src="<?php echo base_url(); ?>public/main_page/js/vendor/modernizr-2.7.1.min.js"></script>
    </head>
    <body id="menu" class="alt-bg">
		...
		<nav class="quick-link count-4 nav-left">
			<div class="logo">
				<a href="#home">
					<img src="<?php echo base_url(); ?>public/main_page/img/logo_only.png" alt="Logo Brand">
				</a>
			</div>
        ...
        <div class="page-cover" id="s-cover">
            ...
            <!--<div class="cover-bg pos-abs full-size slide-show">
				<i class='img' data-src='<?php echo base_url(); ?>public/main_page/img/bg-slide1.jpg'></i>
				<i class='img' data-src='<?php echo base_url(); ?>public/main_page/img/bg-slide2.jpg'></i>
				<i class='img' data-src='<?php echo base_url(); ?>public/main_page/img/bg-slide3.jpg'></i>
				<i class='img' data-src='<?php echo base_url(); ?>public/main_page/img/bg-slide4.jpg'></i>
			</div>-->
            ...
            <div id="container" class="video-container show-for-medium-up">
                <video autoplay="autoplay" loop="loop" autobuffer="autobuffer" muted="muted"
                    ...
                    <source src="<?php echo base_url(); ?>public/main_page/vid/flower_loop.mp4" type="video/mp4">
                </video>
            </div>
...
<!--						<span class="days">12</span><span class="thin">D</span>-->
				...
				<footer>
					<p>Before we launch our <strong>Beta Website</strong></p>
				</footer>                
			</div> 
		</div>
		<!-- End of timer pane -->
        ...
        <main class="page-main" id="mainpage">             
			...
			<div class="section page-home page page-cent" id="s-home">
				...
				<section class="content">
					...
					<header class="header">
						<div class="h-left">
							<h2>XYZ <strong>Flyers</strong></h2>
						</div>
						<div class="h-right">
							<h3>Readymade customizalbe<br>Flyers</h3>
							<h4 class="subhead">will be available soon</h4>
						</div>
					</header>
				</section>
...
<!--		<script src="//code.jquery.com/jquery-1.11.2.min.js"></script>-->
        <script src="<?php echo base_url(); ?>public/main_page/js/vendor/jquery-1.11.2.min.js"></script>
		<!-- All vendor scripts -->
        <script src="<?php echo base_url(); ?>public/main_page/js/vendor/all.js"></script>
		
		<!-- Detailed vendor scripts -->
        <!--<script src="<?php echo base_url(); ?>public/main_page/js/vendor/jquery.fullPage.min.js"></script>
        <script src="<?php echo base_url(); ?>public/main_page/js/vendor/jquery.slimscroll.min.js"></script>
        <script src="<?php echo base_url(); ?>public/main_page/js/vendor/jquery.knob.min.js"></script>
        <script src="<?php echo base_url(); ?>public/main_page/js/vegas/vegas.min.js"></script>
        <script src="<?php echo base_url(); ?>public/main_page/js/jquery.maximage.js"></script>
        <script src="<?php echo base_url(); ?>public/main_page/js/okvideo.min.js"></script>-->
		
		<!-- Downcount JS -->
        <script src="<?php echo base_url(); ?>public/main_page/js/jquery.downCount.js"></script>
		
		<!-- Form script -->
        <script src="<?php echo base_url(); ?>public/main_page/js/form_script.js"></script>
        
		<!-- Javascript main files -->
        <script src="<?php echo base_url(); ?>public/main_page/js/main.js"></script>
