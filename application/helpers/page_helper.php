...
function paging_generate($total,$page,$rows,$max,$navURL, $status = ''){ 
	...
	//-------------------By Rizwan----------------------\\
	if($page*$rows >= $total){
		$nextIcon = '<li><span class="active"><i class="icon icon-chevron-right"></i></span></li>';
	}
	else{
		$pageNext = $page+1;
		...
		$nextIcon = '<li><a href="'.$hrefValue.'"  class="next"><i class="icon icon-chevron-right"></i></a></li>';
	}
	if($page == 1){
		$prevIcon = '<li><span class="previous-off"><i class="icon icon-chevron-left"></i></span></li>';
	}
	else{
		$pagePrev = $page-1;
		$hrefValue = $navURL.'/'.$pagePrev.'/'.$rows.$status_a;
	
		$prevIcon = '<li><a href="'.$hrefValue.'" class="previous"><i class="icon icon-chevron-left"></i></a></li>';
